...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class DeleteTableColumnStatisticsRequest implements org.apache.thrift.TBase<DeleteTableColumnStatisticsRequest, DeleteTableColumnStatisticsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DeleteTableColumnStatisticsRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DeleteTableColumnStatisticsRequest");
  ...
  private static final org.apache.thrift.protocol.TField COL_NAMES_FIELD_DESC = new org.apache.thrift.protocol.TField("col_names", org.apache.thrift.protocol.TType.LIST, (short)4);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new DeleteTableColumnStatisticsRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new DeleteTableColumnStatisticsRequestTupleSchemeFactory();
  ...
  private static final _Fields optionals[] = {_Fields.COL_NAMES};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DeleteTableColumnStatisticsRequest.class, metaDataMap);
  }
   ...
   */
  public DeleteTableColumnStatisticsRequest(DeleteTableColumnStatisticsRequest other) {
  ...
  public DeleteTableColumnStatisticsRequest deepCopy() {
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof DeleteTableColumnStatisticsRequest)
      return this.equals((DeleteTableColumnStatisticsRequest)that);
    return false;
  }

  public boolean equals(DeleteTableColumnStatisticsRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(DeleteTableColumnStatisticsRequest other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DeleteTableColumnStatisticsRequest(");
    boolean first = true;
  ...
  private static class DeleteTableColumnStatisticsRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DeleteTableColumnStatisticsRequestStandardScheme getScheme() {
      return new DeleteTableColumnStatisticsRequestStandardScheme();
    }
  }

  private static class DeleteTableColumnStatisticsRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<DeleteTableColumnStatisticsRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DeleteTableColumnStatisticsRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.col_names = new java.util.ArrayList<java.lang.String>(_list1576.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem1577;
                for (int _i1578 = 0; _i1578 < _list1576.size; ++_i1578)
                {
                  _elem1577 = iprot.readString();
                  struct.col_names.add(_elem1577);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DeleteTableColumnStatisticsRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.col_names != null) {
        if (struct.isSetCol_names()) {
          oprot.writeFieldBegin(COL_NAMES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter1579 : struct.col_names)
            {
              oprot.writeString(_iter1579);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class DeleteTableColumnStatisticsRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DeleteTableColumnStatisticsRequestTupleScheme getScheme() {
      return new DeleteTableColumnStatisticsRequestTupleScheme();
    }
  }

  private static class DeleteTableColumnStatisticsRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<DeleteTableColumnStatisticsRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DeleteTableColumnStatisticsRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCol_names()) {
        {
          ...
          for (java.lang.String _iter1580 : struct.col_names)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DeleteTableColumnStatisticsRequest struct) throws org.apache.thrift.TException {
