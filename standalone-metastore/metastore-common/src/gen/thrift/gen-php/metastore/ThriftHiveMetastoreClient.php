...
class ThriftHiveMetastoreClient extends \FacebookServiceClient implements \metastore\ThriftHiveMetastoreIf
{
    ...
    {
        $this->send_delete_partition_column_statistics_req($req);
        return $this->recv_delete_partition_column_statistics_req();
    }

    public function send_delete_partition_column_statistics_req(\metastore\DeletePartitionColumnStatisticsRequest $req)
    {
        $args = new \metastore\ThriftHiveMetastore_delete_partition_column_statistics_req_args();
        $args->req = $req;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
                $this->output_,
                'delete_partition_column_statistics_req',
                TMessageType::CALL,
                $args,
                $this->seqid_,
                $this->output_->isStrictWrite()
            ...
            $this->output_->writeMessageBegin('delete_partition_column_statistics_req', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_delete_partition_column_statistics_req()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\metastore\ThriftHiveMetastore_delete_partition_column_statistics_req_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \metastore\ThriftHiveMetastore_delete_partition_column_statistics_req_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
        ...
        throw new \Exception("delete_partition_column_statistics_req failed: unknown result");
    }
    ...
    {
        $this->send_delete_table_column_statistics_req($req);
        return $this->recv_delete_table_column_statistics_req();
    }

    public function send_delete_table_column_statistics_req(\metastore\DeleteTableColumnStatisticsRequest $req)
    {
        $args = new \metastore\ThriftHiveMetastore_delete_table_column_statistics_req_args();
        $args->req = $req;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
                $this->output_,
                'delete_table_column_statistics_req',
                TMessageType::CALL,
                $args,
                $this->seqid_,
                $this->output_->isStrictWrite()
            ...
            $this->output_->writeMessageBegin('delete_table_column_statistics_req', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_delete_table_column_statistics_req()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\metastore\ThriftHiveMetastore_delete_table_column_statistics_req_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \metastore\ThriftHiveMetastore_delete_table_column_statistics_req_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
        ...
        throw new \Exception("delete_table_column_statistics_req failed: unknown result");
    }
