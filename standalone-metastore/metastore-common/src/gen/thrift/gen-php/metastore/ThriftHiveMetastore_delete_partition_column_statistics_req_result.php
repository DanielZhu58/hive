...
class ThriftHiveMetastore_delete_partition_column_statistics_req_result
{
    ...
    {
        return 'ThriftHiveMetastore_delete_partition_column_statistics_req_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ThriftHiveMetastore_delete_partition_column_statistics_req_result');
